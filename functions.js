...
async function allSEARCH(keyword) {
  let result=[];
  result= await Promise.all([unsplashSEARCH(keyword), pixabaySEARCH(keyword), storybloacksSEARCH(keyword)])
  .then(value => {
    result=value.flat();
    console.log('new value',result);
    console.log('end of function allSEARCH');
    return result;
  })
  .catch(err => {
...
exports.pixabaySEARCH = pixabaySEARCH;
exports.storybloacksSEARCH = storybloacksSEARCH;
